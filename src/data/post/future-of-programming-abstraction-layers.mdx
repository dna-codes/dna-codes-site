...
series:
  ...
  # No `layer` — this piece is the map, not a rung on it.
author: Tim Kleier
...
image: '~/assets/images/series/future-of-programming-abstraction-layers.png'
...
<SeriesNav current="future-of-programming-abstraction-layers" />
