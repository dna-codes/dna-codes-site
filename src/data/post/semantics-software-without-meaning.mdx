...
We're building [DNA Codes](/) to make the middle of the ladder real: terms defined once, in the place the layers below are read from. If this is how you're thinking about the problem too, [join the waitlist](/waitlist).
